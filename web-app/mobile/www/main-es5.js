...
var environment = 'http://147.87.133.169:3333';
...
/* harmony import */ var _techiediaries_ngx_qrcode__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @techiediaries/ngx-qrcode */ "./node_modules/@techiediaries/ngx-qrcode/fesm5/techiediaries-ngx-qrcode.js");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(userService, store, router) {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(_store_user_user_reducer__WEBPACK_IMPORTED_MODULE_6__["selectUser"]).subscribe(function (user) {
            console.log(user);
            if (user.id) {
    ...
    LoginComponent.prototype.signIn = function (email, pass) {
        ...
        this.userService.login(userObj).subscribe(function (user) {
            console.log(user);
            if (user) {
                _this.store.dispatch(new _store_user_user_actions__WEBPACK_IMPORTED_MODULE_4__["UpdateUser"](user));
...
var OffersComponent = /** @class */ (function () {
    function OffersComponent(regionService, store) {
...
var QrDisplayComponent = /** @class */ (function () {
...
var RegionDetailComponent = /** @class */ (function () {
    function RegionDetailComponent(route, regionsService, store) {
        this.route = route;
    ...
    RegionDetailComponent.prototype.ngOnInit = function () {
        ...
        this.regionsService.getRegionByName(this.route.snapshot.params.region).subscribe(function (region) {
            _this.region = region[0];
        });
    };
    RegionDetailComponent.ctorParameters = function () { return [
...
var RegionsComponent = /** @class */ (function () {
    function RegionsComponent(regionsService, router, store) {
        this.regionsService = regionsService;
        this.router = router;
        this.store = store;
        this.regions = [];
    ...
    RegionsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.regionsService.getAllRegions().subscribe(function (regions) {
            _this.regions = regions;
            _this.store.dispatch(new _store_regions_regions_actions__WEBPACK_IMPORTED_MODULE_4__["RegionsAddAll"](_this.regions));
        });
    };
    RegionsComponent.prototype.navigateTo = function (url) {
        this.router.navigateByUrl(url);
    };
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(userService, store, router) {
        this.userService = userService;
        this.store = store;
        this.router = router;
    ...
    RegisterComponent.prototype.register = function (email, pass, firstname, lastname, dateofbirth) {
        var _this = this;
        var userObj = {
            created: new Date(),
        ...
        this.userService.register(userObj).subscribe(function (user) {
            if (user) {
                _this.store.dispatch(new _store_user_user_actions__WEBPACK_IMPORTED_MODULE_5__["UpdateUser"](user));
...
var UserComponent = /** @class */ (function () {
    function UserComponent(userService, store, router) {
        this.userService = userService;
        this.store = store;
        this.router = router;
    ...
    UserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(_store_user_user_reducer__WEBPACK_IMPORTED_MODULE_5__["selectUser"]).subscribe(function (user) {
            console.log(user);
            if (user.id) {
                _this.displayProfile = true;
            }
            else {
...
var PurchasesService = /** @class */ (function () {
    ...
    PurchasesService.prototype.getPurchasesByUser = function (userId) {
        return this.http.get(this.uri + ("/offers/" + userId), this.headers);
    };
    PurchasesService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
...
var RegionsService = /** @class */ (function () {
    ...
    RegionsService.prototype.getAllRegions = function () {
        return this.http.get(this.uri + '/regions', this.headers);
    };
    RegionsService.prototype.getRegionByName = function (name) {
...
var ActionEx = /** @class */ (function () {
    function ActionEx() {
    }
    return ActionEx;
}());

var OffersAdd = /** @class */ (function () {
    function OffersAdd(payload) {
        this.payload = payload;
        this.type = OffersActionTypes.Add;
    }
    OffersAdd.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return OffersAdd;
}());

var OffersAddAll = /** @class */ (function () {
    function OffersAddAll(payload) {
        this.payload = payload;
        this.type = OffersActionTypes.AddAll;
    }
    OffersAddAll.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return OffersAddAll;
}());

var OffersRemove = /** @class */ (function () {
    function OffersRemove(payload) {
        this.payload = payload;
        this.type = OffersActionTypes.Remove;
    }
    OffersRemove.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return OffersRemove;
}());
...
var selectFeature = function (state) { return state.root.Offers; };
var selectIds = (_a = adapter.getSelectors(selectFeature), _a.selectIds), selectEntities = _a.selectEntities, selectAll = _a.selectAll;
var selectOffers = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["createSelector"])(selectAll, function (state) { return state; });
...
var RegionsAdd = /** @class */ (function () {
    function RegionsAdd(payload) {
        this.payload = payload;
        this.type = RegionsActionTypes.Add;
    }
    RegionsAdd.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return RegionsAdd;
}());

var RegionsAddAll = /** @class */ (function () {
    function RegionsAddAll(payload) {
        this.payload = payload;
        this.type = RegionsActionTypes.AddAll;
    }
    RegionsAddAll.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return RegionsAddAll;
}());

var RegionsRemove = /** @class */ (function () {
    function RegionsRemove(payload) {
        this.payload = payload;
        this.type = RegionsActionTypes.Remove;
    }
    RegionsRemove.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return RegionsRemove;
}());
...
var selectFeature = function (state) { return state.root.regions; };
var selectIds = (_a = adapter.getSelectors(selectFeature), _a.selectIds), selectEntities = _a.selectEntities, selectAll = _a.selectAll;
var selectRegions = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["createSelector"])(selectAll, function (state) { return state; });
...
function UserReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case _user_actions__WEBPACK_IMPORTED_MODULE_1__["UserActionTypes"].UpdateUser:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { id: action.payload.id, name: action.payload.name, firstname: action.payload.firstname, email: action.payload.email, dateOfBirth: action.payload.dateOfBirth, created: action.payload.created });
        default:
            return state;
    }
}
var selectFeature = function (state) { return state.root.user; };
var selectUser = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["createSelector"])(selectFeature, function (state) { return state; });
